...
import type { IChangeContext, IObservable, IObserver, IReader } from './base';
import { _setDerived, BaseObservable, getFunctionName } from './base';
...
export function derivedOpts<T>(
  options: { debugName?: string | (() => string); equalityComparer?: EqualityComparer<T> },
...
export class Derived<T, TChangeSummary = any> extends BaseObservable<T> implements IReader, IObserver {
