...
export abstract class Disposable implements IDisposable {
   ...
   */
  static readonly None = Object.freeze<IDisposable>({ dispose: function () {} });
...
export class SafeDisposable implements IDisposable {
  ...
  // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types, @typescript-eslint/no-unsafe-function-type
  set(fn: Function) {
