...
import type { CommandCallback } from '@/common/commands/command';
import { registerWebviewCommand } from '@/common/commands/command';
      ...
      registration = {
        subscription: registerWebviewCommand(
          ...
          (...args: any[]) => {
            ...
            const key = context.webviewInstance ? `${context.webview}:${context.webviewInstance}` : context.webview;
